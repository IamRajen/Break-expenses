...
public class TripExpenseMembers {


    String id,member_name,member_phone_number,to_be_paid,paid,member_parent_id;


    public TripExpenseMembers(String id, String member_name, String member_phone_number, String to_be_paid, String paid, String member_parent_id) {
        this.id = id;
